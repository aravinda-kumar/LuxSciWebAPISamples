...
Namespace LuxSciWebApi
    Class Program
        Shared TOKEN As String = "Tc3/kiUnOIcpMo82Sq4waEsKdKwGbEBVi2cDjgnkn2k"
        Shared SECRET As String = "o92OSj7w42dDhN4szMDSvjm+r5fcNd92/aU6vafMI2w"
        Shared USER_TOKEN As String = "09TnvMTrYhqWuIt/ZvI9BhQ3toYMe/89PobjIiR/7bg"
        Shared USER_SECRET As String = "rBDbKmkwb0wDlpEsYTWvYFi1v04Wp5OiC3hh4wPJ2e8"
        Shared EMAIL_ID As String = "admin@apidev18.trial6.luxsci.net"
        Private Shared EMAIL_PASSWORD As String = "vjnxy32!x"
        Private Shared SUCCESS_RESPONSE As Integer = 1
        Private Shared ACCOUNT_CODE As String = "18184"
        ...
        Private Shared Async Function ProcessUserRequests() As Task
            ...
            If resp.success = SUCCESS_RESPONSE Then
                ...
                emailReq.[To] = New String() {"arvnda@gmail.com", "aravinda_kumar@yahoo.com", "aravinda@aravinda.in"}
                emailReq.FromName = "AravindaLuxSci"
        ...
        Private Shared Async Function ProcessAccountRequests() As Task
            ...
            If resp.success = SUCCESS_RESPONSE Then
                ...
                [alias].Domain = "demouser@apidev18.trial6.luxsci.net"
                [alias].Dest = "demouser@apidev18.trial6.luxsci.net"
                [alias].Bounce = "arvnda@gmail.com"
        ...
        Public Shared Async Function SendMailWithAttachment() As Task(Of LuxSciResponse)
            ...
            emailReq.Subject = "Hello, test message"
            emailReq.Body = "Dear User " & vbLf & " This is a test message for you from LuxSci, using amazing APIs. " & vbLf & " Regards " & vbLf & " LuxSciTeam"
            emailReq.[To] = New String() {"arvnda@gmail.com"}
            emailReq.FromName = "AravindaLuxSci"
            emailReq.FromAddress = EMAIL_ID
            emailReq.BodyType = "text"
